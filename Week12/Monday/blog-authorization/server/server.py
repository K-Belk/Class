...
import json
from views import build_json_response, handle_posts, handle_login
...
def main():
    ...
    while True:
        ...
        if client_request.parsed_request['uri'] == '/login':
            resp = handle_login(client_request.parsed_request)
